...
const WorkPage = () => {
  ...
  return (
    ...
    //       className={`w-full absolute flex flex-col lg:flex-row transition-all duration-[4000ms] ease-in-out ${currentSlide === index ? "translate-y-0 h-full opacity-100" : "-translate-y-full opacity-0"} `} >
